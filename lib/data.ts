...
export const CATEGORIES: Category[] = [
  { id: "food",  label: "Đồ Ăn",             icon: "🥩",  subtitle: "Thịt Gác Bếp · Thịt Trâu Muối · Cá Suối",            desc: "Đặc sản thịt hun khói truyền thống của đồng bào dân tộc Thái, Mường — mang vị đậm đà của núi rừng Sơn La.", grad: "from-stone-900 to-amber-900",    products: ["Thịt Gác Bếp Trâu", "Thịt Bò Khô Mắc Khén", "Cá Khô Suối"],               count: "5+ sản phẩm" },
