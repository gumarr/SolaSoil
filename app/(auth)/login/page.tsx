...
export const metadata = {
  title: 'Đăng nhập | Mộc Sơn',
  description: 'Đăng nhập vào tài khoản Mộc Sơn của bạn để mua hàng OCOP chất lượng cao.',
}
...
export default async function LoginPage() {
  ...
  // Redirect to home or admin if already logged in
  if (user) {
